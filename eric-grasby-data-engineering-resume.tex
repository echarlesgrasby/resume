...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:ecgrasby@icloud.com}{ecgrasby@icloud.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://ericgrasby.xyz/}{https://ericgrasby.xyz/}}%
    \end{header}

    \vspace{5 pt - 0.3 cm}
    \section{Profile}
        \begin{onecolentry}
            Software engineer and data systems specialist with 10+ years of experience building production applications and platforms in the energy sector and beyond. 
            My expertise spans full-stack application development, cloud infrastructure, and large-scale data processing, including a research focus on monitoring and surveillance systems for wholesale electricity markets. 
            I am currently pursuing a Ph.D. while contributing to market monitoring applications at SPP.
        \end{onecolentry}
...
%
   ...
   % \end{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Served as the primary developer for the Engineering Platform project at SPP, a Kubernetes-based web application that spawns user-defined processes to run on the Argo Workflows platform (hosted at SPP). This granted our engineering division (90+ electrical engineers) the ability to develop custom workflows to process electrical engineering studies.
        ...
        \vspace{0.15 cm}
        \textit{This was a short-term engagement for skills development in DevOps and cloud infrastructure}
        \vspace{0.25 cm}
        \begin{onecolentry}
            \begin{highlights}
    ...
    \vspace{0.2 cm}
        ...
        \textbf{Dissertation} \\
            \vspace{0.10 cm}
                A Domain-Specific Language Approach to Monitoring and Surveillance in Wholesale Electricity Markets ---  \url{https://github.com/echarlesgrasby/dissertation}
            \end{onecolentry}
%
            \vspace{0.10 cm}
        ...
        \begin{onecolentry}
            ...
            \vspace{0.10 cm}
            Invited reviewer, IEEE International Conference on Big Data (2025); Applied AI for Public Safety and Security Workshop on Big Data (AI-PublicSecurity-2025) \\        
        \end{onecolentry}
