...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            Software engineer and data systems specialist with 10+ years of experience building production applications and platforms in the energy sector and beyond. My expertise spans full-stack application development, cloud infrastructure, and large-scale data processing, including a research focus on monitoring and surveillance systems for wholesale electricity markets. I am currently pursuing a Ph.D. while contributing to market monitoring applications at SPP.
            \vspace{0.2 cm}
   ...
   % \end{onecolentry}
    ...
    \vspace{0.2 cm}
        ...
        \vspace{0.5 cm}
            ...
            \begin{onecolentry}
                \textbf{Dissertation: A Domain-Specific Language Approach to Monitoirng and Surveillance in Wholesale Electricity Markets}
                \newline
...
%
        ...
        \begin{onecolentry}
            \vspace{0.10 cm}
            Invited reviewer (courtesy of Dr. Wei Dai, Purdue Northwest), IEEE International Conference on Big Data (2025, Macau) \\
            Applied AI for Public Safety and Security Workshop on Big Data \textit{(AI-PublicSecurity-2025)}
        \end{onecolentry}
